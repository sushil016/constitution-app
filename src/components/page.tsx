    ...
    <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Embark on a journey of constitutional literacy with our
                  gamified approach. Understand the pillars of Indian democracy
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <p className="mt-4 max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              "Sansthaein Aur Samvidhan" is dedicated to spreading
              constitutional literacy among citizens. We simplify the language
              of the Constitution of India, focusing on the institutional
              perspective including the Legislature, Executive, and Judiciary.
            </p>
          </div>
        </section>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    Immerse yourself in role-playing simulations that bring
                    constitutional concepts to life.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    Compete with others in real-time rankings and collaborative
              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    Engage in discussions, seek guidance, and share insights
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-500">
                    Embark on a journey from age 3 to 90, learning about the
                    Constitution at every stage of life.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-500">
                    Step into the shoes of judges, citizens, and other key
                    figures in the Indian democracy.
                  </p>
                </CardContent>
              </Card>
              <Card>
        ...
        <section id="community" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 mb-8">
              Engage with fellow learners, share insights, and seek guidance in
              our vibrant community. Our Stack Overflow-like platform ensures
              you always have support in your constitutional journey.
            </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>
                        Onboarding animation based on constitutional concepts
                      </li>
                      <li>Age-adaptive dashboard content</li>
                      <li>
                        Features: available games, user progress display,
                        learning animations, and community sharing
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>
                        Multiple game types (family mode multiplayer,
                        decision-making game, etc.)
                      </li>
      ...
      <footer className="w-full py-6 bg-gray-100 dark:bg-gray-800">
        ...
        <div className="container px-4 md:px-6 mt-4 text-center text-sm text-gray-500">
          © {new Date().getFullYear()} Sansthaein Aur Samvidhan. All rights
          reserved.
        </div>
      </footer>
    </div>
